...
export default async function QuoteDetailPage({
  ...
  return (
    <div className="flex flex-col gap-6">
      <BackLink href="/account/quotes" label="Back to quotes" />
      ...
      {issued === "true" ? (
        <div className="flex items-start gap-3 rounded-2xl border border-champagne-300 bg-champagne-200/20 p-5">
          ...
          <div>
            <p className="font-display text-lg font-medium text-espresso-950">Your quotation is ready</p>
      ...
      <div className="overflow-hidden rounded-2xl bg-gradient-to-br from-espresso-950 to-espresso-950 p-6 sm:p-8">
