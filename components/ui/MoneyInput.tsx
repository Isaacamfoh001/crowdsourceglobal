    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative">
        ...
        <input
          ...
          required={required}
          disabled={disabled}
          className="w-full rounded-lg border border-ivory-400 bg-white py-3 pl-12 pr-3.5 text-[15px] font-medium text-espresso-950 shadow-soft outline-none transition-colors focus:border-forest-700 focus:ring-2 focus:ring-forest-700/10 disabled:bg-ivory-100"
        />
      </div>
