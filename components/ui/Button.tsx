...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "bg-espresso-800 text-ivory-50 hover:bg-espresso-900 active:bg-espresso-950 focus-visible:outline-espresso-800 disabled:bg-ivory-300 disabled:text-espresso-900/40",
  secondary:
  ...
  outline:
    "border border-ivory-400 bg-ivory-50 text-espresso-950 hover:border-champagne-400 hover:bg-ivory-100 focus-visible:outline-espresso-800 disabled:text-espresso-900/30",
  ghost:
    "bg-transparent text-espresso-800 hover:bg-ivory-100 focus-visible:outline-espresso-800 disabled:text-espresso-900/30",
  danger:
