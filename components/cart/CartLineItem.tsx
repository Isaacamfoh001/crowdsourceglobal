...
export function CartLineItem({ line }: { line: CartLineView }) {
  ...
  return (
    <div className="flex gap-4 border-b border-stone-100 py-5 last:border-0">
      <Link href={`/listings/${line.listingId}`} className="shrink-0">
        <ListingImagePlaceholder categorySlug={line.categorySlug} className="size-20 rounded-xl" />
      </Link>
      ...
      <p className="shrink-0 text-right text-[15px] font-semibold text-stone-900">
