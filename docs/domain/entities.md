...
**Shipment** — id `PK`, fulfilmentId `FK→Fulfilment IDX`, deliveryMethod (`vendor_arranged|crownsource_arranged|third_party_courier`), carrier (nullable), trackingReference (nullable), status, dispatchedAt, deliveredAt.
